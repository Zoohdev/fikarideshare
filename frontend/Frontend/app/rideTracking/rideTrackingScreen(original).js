    ...
    return (
      ...
      >
        ...
        {role === "driver" && displayWaypoints.map((wp, index) => {
          ...
          return (
            <Marker key={`wp-${index}`} coordinate={{ latitude: lat, longitude: lng }} anchor={{ x: 0.5, y: 0.9 }}>
              <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                <View style={{
                  ...
                  shadowColor: '#000', shadowOpacity: 0.2, shadowRadius: 3, elevation: 5, marginBottom: 4, maxWidth: 140
                }}>
                  <Text numberOfLines={1} style={{ color: '#FFFFFF', fontSize: 11, fontWeight: '700', textAlign: 'center' }}>
